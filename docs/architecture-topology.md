# Veloz Platform — Architecture Topology
...
but not yet built. This is the detailed companion to the high-level diagram
in [`docs/architecture-diagram.md`](architecture-diagram.md) — start there
for the 10-second version; come here for the container/service topology and
data flow.
